...
/**
  * The parameters for es.alvsanand.sgdc.ftp.secure.SFTPSgdcDownloader.
  *
...
/**
  ...
  */
private[secure]
class SFTPSgdcDownloader(parameters: SFTPParameters)
  extends SgdcDownloader[FTPSlot, SFTPParameters](parameters) {
