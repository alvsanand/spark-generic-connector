...
/**
  * The parameters for es.alvsanand.sgdc.ftp.normal.FTPSgdcDownloader.
  *
...
/**
  ...
  */
private[normal]
class FTPSgdcDownloader(parameters: FTPParameters)
  extends SgdcDownloader[FTPSlot, FTPParameters](parameters) {
