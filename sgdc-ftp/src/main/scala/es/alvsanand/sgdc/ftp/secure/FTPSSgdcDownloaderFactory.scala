...
/**
  ...
  */
object FTPSSgdcDownloaderFactory extends SgdcDownloaderFactory[FTPSlot, FTPSParameters] {
  ...
  /**
    ...
    */
  override def get(parameters: FTPSParameters): SgdcDownloader[FTPSlot, FTPSParameters] = {
    new FTPSSgdcDownloader(parameters)
  }
}
