...
import es.alvsanand.sgdc.core.util.IOUtils
import es.alvsanand.sgdc.google.GoogleHelper
...
/**
  * The es.alvsanand.sgdc.core.downloader.SgdcSlot implementation for
  * es.alvsanand.sgdc.google.dcm_data_transfer.DataTransferSgdcDownloader.
  *
...
case class DataTransferSlot(name: String, date: Date,
                            ddtFileType: Option[DataTransferFileType] = None) extends SgdcDateSlot

/**
  * The parameters for es.alvsanand.sgdc.google.dcm_data_transfer.DataTransferSgdcDownloader.
...
case class DataTransferParameters(credentialsZipPath: String, bucket: String,
  ...
  extends SgdcDownloaderParameters

/**
  * This is a [[https://support.google.com/dcm/partner/answer/165589?hl=en DoubleClick Data Transfer]]
  * implementation of es.alvsanand.sgdc.core.downloader.SgdcDownloader. It list and download all the
...
class DataTransferSgdcDownloader(parameters: DataTransferParameters)
  extends SgdcDownloader[DataTransferSlot, DataTransferParameters](parameters) {
