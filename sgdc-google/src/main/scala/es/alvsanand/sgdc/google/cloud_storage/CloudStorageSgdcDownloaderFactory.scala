...
/**
  ...
  */
object CloudStorageSgdcDownloaderFactory
    extends SgdcDownloaderFactory[CloudStorageSlot, CloudStorageParameters] {
  ...
  override def get(parameters: CloudStorageParameters):
      SgdcDownloader[CloudStorageSlot, CloudStorageParameters] = {
    new CloudStorageSgdcDownloader(parameters)
  }
}
