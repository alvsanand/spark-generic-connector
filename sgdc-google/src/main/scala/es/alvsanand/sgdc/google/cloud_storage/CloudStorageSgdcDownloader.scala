...
/**
  ...
  * es.alvsanand.sgdc.google.cloud_storage.CloudStorageSgdcDownloader.
  *
  * Note: every CloudStorageSlot corresponds to a file in Google Cloud Storage
  * @param name The name of the file
  * @param date The creation date of the file
  */
case class CloudStorageSlot(name: String, date: Date) extends SgdcDateSlot

/**
  * The parameters for es.alvsanand.sgdc.google.cloud_storage.CloudStorageSgdcDownloader.
...
/**
  ...
  * es.alvsanand.sgdc.core.downloader.SgdcDownloader. It list and download all the files that are in
  * a configured bucket.
  *
...
class CloudStorageSgdcDownloader(parameters: CloudStorageParameters)
  extends SgdcDownloader[CloudStorageSlot, CloudStorageParameters](parameters) {
