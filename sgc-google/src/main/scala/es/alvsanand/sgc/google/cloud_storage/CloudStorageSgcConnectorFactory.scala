...
/**
  ...
  * fetch all the files that are in a configured bucket.
  *
  ...
  */
object CloudStorageSgcConnectorFactory
    extends SgcConnectorFactory[CloudStorageSlot, CloudStorageParameters] {
  ...
  override def get(parameters: CloudStorageParameters):
      SgcConnector[CloudStorageSlot, CloudStorageParameters] = {
    new CloudStorageSgcConnector(parameters)
  }
}
