...
import org.apache.spark.util.gdc.DownloadFile
...
/**
  ...
  */
case class DoubleClickDataTransferFile(file: String, date: Option[Date] = None,
                                       ddtFileType: Option[DoubleClickDataTransferFileType] = None) extends DownloadFile
